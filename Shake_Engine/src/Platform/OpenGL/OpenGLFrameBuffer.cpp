...
namespace Shake
{
    ...
    void OpenGLFrameBuffer::Invalidate()
    {
       ...
       //glTexStorage2D(GL_TEXTURE_2D, 1, GL_DEPTH24_STENCIL8, m_frameBufferSpecification.width, m_frameBufferSpecification.height);
    ...
    const FramebufferSpecifications& OpenGLFrameBuffer::GetSpecification() const
    {
