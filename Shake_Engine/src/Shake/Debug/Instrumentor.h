...
#define SE_PROFILE 1
#if SE_PROFILE
#define SE_PROFILE_BEGIN_SESSION(name, filepath) ::Shake::Instrumentor::Get().BeginSession(name, filepath)
#define SE_PROFILE_END_SESSION() ::Shake::Instrumentor::Get().EndSession()
#define SE_PROFILE_SCOPE(name) ::Shake::InstrumentationTimer timer##__LINE__(name);
